...
for ch,(a,b) in chain.items():
    ...
    while True:
        ...
        k=j+1
print("1e5e9", blob[0x1e5e9-va:0x1e5e9-va+4].hex())
print("1e624", blob[0x1e624-va:0x1e624-va+8].hex())
pe[rp:rp+rs]=blob
pathlib.Path("build_univ227/cmd_univ7.exe").write_bytes(pe)
df.suppress_fault_ui()
exe=pathlib.Path("build_univ227/cmd_univ7.exe").resolve()
