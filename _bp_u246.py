...
IB=0x80000000
BPS={IB+0x19029:"pre", IB+0x1902e:"post", IB+0x489c0:"MATCH", IB+0x18b5d:"lookup", IB+0x18157:"eEcho", IB+0x1d35c:"f4eb", IB+0x36268:"r9set"}
    ...
    if de.dwDebugEventCode==df.CREATE_PROCESS_DEBUG_EVENT:
        ...
        if code==0x80000003:
            ...
            if bp is not None:
                ...
                print(f"HIT {BPS[bp]} rax={ctx.Rax:#x} rdi={ctx.Rdi:#x} r8={ctx.R8:#x} r9={ctx.R9:#x}{extra}")
                if hits>35: k32.TerminateProcess(pi.hProcess,1); break
