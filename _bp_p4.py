...
exe=os.path.abspath("cmd_probe4.exe")
IB=0x80000000
BPS={IB+0x1d5b4:"f5ed", IB+0x1e2b4:"fbe4", IB+0x262d1:"ultoa", IB+0x2632a:"mb2wc", IB+0x18157:"eEcho", IB+0x19029:"pre", IB+0x489c0:"MATCH", IB+0x18b5d:"lookup"}
    ...
    if de.dwDebugEventCode==df.CREATE_PROCESS_DEBUG_EVENT:
        ...
        if code==0x80000003:
            ...
            if bp is not None:
                ...
                print(f"HIT {BPS[bp]} rax={ctx.Rax:#x} rcx={ctx.Rcx:#x} rdx={ctx.Rdx:#x} r8={ctx.R8:#x} r9={ctx.R9:#x}{extra}")
