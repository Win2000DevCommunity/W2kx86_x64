...
IB=0x80000000
BPS={IB+0x19029:"pre_search", IB+0x1902e:"post_search", IB+0x2725a:"cmp_ret", IB+0x48a87:"MATCH", IB+0x18b5d:"lookup_ret", IB+0x18157:"eEcho", IB+0x3625e:"set_r8", IB+0x1d35c:"f4eb", IB+0x3988e:"call_cb"}
    ...
    if de.dwDebugEventCode==df.CREATE_PROCESS_DEBUG_EVENT:
        ...
        if code==0x80000003:
            ...
            if bp is not None:
                ...
                print(f"HIT {BPS[bp]} rax={ctx.Rax:#x} r8={ctx.R8:#x} r9={ctx.R9:#x}{extra}")
