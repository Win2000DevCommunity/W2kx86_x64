...
out = root / "build_univ255"
out.mkdir(exist_ok=True)
env = os.environ.copy(); env["PURE"]="1"; env["PYTHONUNBUFFERED"]="1"; env["PYTHONDONTWRITEBYTECODE"]="1"
cmd=[r"C:\Python314\python.exe","-u","-B",str(root/"x86_x64.py"),"--pure","--win10-test-shim",str(src),str(out/"cmd_pure.exe")]
