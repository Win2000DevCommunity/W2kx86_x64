...
IB = 0x80000000
BPS = {
    IB + 0x1d5e2: "after_fbe4",
    IB + 0x1d60d: "f5ed_cont",
    IB + 0x1d61a: "call_1d7f4",
    IB + 0x1d62a: "je_48900",
    IB + 0x48900: "at_48900",
    IB + 0x1e64a: "body_1e64a",
    IB + 0x39892: "call_cb",
    IB + 0x1ea3c: "ff31ish",
}
    ...
    if de.dwDebugEventCode == df.CREATE_PROCESS_DEBUG_EVENT:
        ...
        if code == 0x80000003:
            ...
            if bp is not None:
                ...
                hits += 1
                extra = ""
                if BPS[bp] in ("after_fbe4", "je_48900"):
                    slot = rd(ctx.Rbp - 4, 4)
                    v = struct.unpack("<I", slot)[0] if slot else -1
                    extra = " eax=%#x [rbp-4]=%#x" % (ctx.Rax, v)
                if BPS[bp] == "call_cb":
                    slot = rd(ctx.Rbp + 0x28, 8)
                    v = struct.unpack("<Q", slot)[0] if slot else 0
                    extra = " [rbp+28]=%#x" % v
