...
IB=0x80000000
# BP on returns to pe64 text from calls in print
BPS={
 IB+0xca01: "after_call1",
 IB+0xca49: "after_call2",
 IB+0xca6a: "after_call3",
 IB+0xca80: "p_ca80",
 IB+0xcac0: "p_cac0",
 IB+0xcb00: "p_cb00",
    ...
    if de.dwDebugEventCode==df.CREATE_PROCESS_DEBUG_EVENT:
        ...
        if code==0x80000003:
            ...
            if bp is not None:
                ...
                print(f"HIT {BPS[bp]} rax={ctx.Rax:#x} rcx={ctx.Rcx:#x} rdx={ctx.Rdx:#x} r8={ctx.R8:#x} rsi={ctx.Rsi:#x}")
            else:
                skips+=1
                if skips>15:
                    ctx=df.get_thread_context(pi.hThread)
