...
# More? string at 0x4ad01a08
needle=struct.pack("<I", 0x4ad01a08)
idx=0
print("refs to More? string:")
while True:
    j=blob.find(needle,idx)
    if j<0: break
    for back in range(0,6):
        for insn in md.disasm(blob[j-back:j-back+12], base32+va32+j-back, count=2):
            if "0x4ad01a08" in insn.op_str:
