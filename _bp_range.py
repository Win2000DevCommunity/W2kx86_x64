...
TARGETS = {
    0x80012789: "call29628",
    0x800127a0: "call143bc",
    0x800127c1: "call46e88",
    0x800127c6: "after46e88",
    0x80012824: "call26104",
    0x80012856: "callIAT1",
    0x80012874: "call2a104",
    0x80012898: "callIAT2",
    0x800128d3: "callIAT3",
    0x800128e7: "call7a98",
    0x800128fe: "mov20c",
    ...
    if de.dwDebugEventCode == df.EXCEPTION_DEBUG_EVENT:
        ...
        if ec == 0x80000003:
            ...
            if hit is not None:
                ...
                print(f"HIT {name} rbp={ctx.Rbp:x} rsi={ctx.Rsi:x} rdi={ctx.Rdi:x} rcx={ctx.Rcx:x} rdx={ctx.Rdx:x}")
                hits.append(name)
        ...
        if ec == 0xC0000005:
            ctx = CTX(); ctx.ContextFlags = CONTEXT_FULL
            k32.GetThreadContext(pi.hThread, C.byref(ctx))
            print(f"AV rip={ctx.Rip:x} rbp={ctx.Rbp:x}")
            print("hits", hits)
            break
