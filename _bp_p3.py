...
IB=0x80000000
BPS={IB+0x1d35c:"f4eb", IB+0x1d4f4:"f5a8", IB+0x1d534:"f5bf", IB+0x1d574:"f5d6", IB+0x18157:"eEcho", IB+0x19029:"pre", IB+0x1902e:"post", IB+0x489c0:"MATCH", IB+0x18b5d:"lookup"}
    ...
    if de.dwDebugEventCode==df.CREATE_PROCESS_DEBUG_EVENT:
        ...
        if code==0x80000003:
            ...
            if bp is not None:
                ...
                print(f"HIT {BPS[bp]} rax={ctx.Rax:#x} rdx={ctx.Rdx:#x} r8={ctx.R8:#x} r9={ctx.R9:#x}{extra}")
                if hits>50: k32.TerminateProcess(pi.hProcess,1); break
        elif code in (0xC0000005,0xC0000374):
            ctx=df.get_thread_context(pi.hThread)
            print(f"EXC {code:#x} rip={ctx.Rip:#x} write={er.ExceptionInformation[0]} addr={er.ExceptionInformation[1]:#x}")
