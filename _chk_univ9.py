import struct, pathlib, sys, os, subprocess
os.environ["PURE"]="1"
sys.path.insert(0, ".")
...
print("diam", t._pure_fix_switch_diamond_code_arg_movabs(blob, {}))
# manual diamond chain if needed
...
for ch,(a,b) in chain.items():
    ...
    while True:
        ...
        k=j+1
print("17d33", blob[0x17d33-va:0x17d33-va+10].hex())
pe[rp:rp+rs]=blob
pathlib.Path("build_univ227/cmd_univ9.exe").write_bytes(pe)
df.suppress_fault_ui()
exe=pathlib.Path("build_univ227/cmd_univ9.exe").resolve()
