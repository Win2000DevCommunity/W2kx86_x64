...
os.chdir("build_univ241")
exe=os.path.abspath("cmd_probe.exe")
IB=0x80000000
BPS={IB+0x19029:"pre_search", IB+0x1902e:"post_search", IB+0x48a87:"MATCH", IB+0x18b5d:"lookup_ret", IB+0x18157:"eEcho", IB+0x1d35c:"f4eb", IB+0x36268:"r9"}
        ...
        if code==0x80000003:
            ...
            if st:
                ...
                for i in range(0,0x118,8):
                    ...
                    if IB<=v<IB+0x90000 or (v>>40)==0x7ff:
