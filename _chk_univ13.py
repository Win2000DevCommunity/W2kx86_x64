...
t = T()
print("19fe0 raw", blob[0x19fe0-va:0x19fe0-va+16].hex())
for name, fn in [
    ...
    ("hr", lambda: t._pure_fix_heaprealloc_mem_arg_after_getprocessheap(blob)),
]:
    print(name, fn())
print("19fe0 after", blob[0x19fe0-va:0x19fe0-va+16].hex())
...
for ch,(a,b) in chain.items():
    ...
    while True:
        ...
        k=j+1
pe[rp:rp+rs] = blob[:rs]
pathlib.Path("build_univ227/cmd_univ13.exe").write_bytes(pe)
df.suppress_fault_ui()
exe=pathlib.Path("build_univ227/cmd_univ13.exe").resolve()
